 ...
 */
public class XmpHandlerOrig implements ImageHandler
{
    private static final LogFactory LOGGER = LogFactory.getLogger(XmpHandlerOrig.class);
    ...
    {
        try (XmpHandlerOrig handler = new XmpHandlerOrig(input))
        {
     ...
     *         if the data is malformed
     */
    public XmpHandlerOrig(byte[] input) throws XMPException
    {
