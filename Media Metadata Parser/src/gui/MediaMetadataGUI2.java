 ...
 * </p>
 */
public class MediaMetadataGUI2 extends Application
{
    private Stage stage;
     ...
     *
     * <p>
     * Configures source-field interaction, clipboard handling, control bindings, and metadata display behaviour.
     * </p>
     *
     * @param pane
    ...
    /**
     * Attaches the specified action handler to the application's interactive controls.
     *
     * @param handler
     *        the action handler responsible for processing control events
     */
    ...
    /**
     * Handles user actions generated by the main application controls.
     */
    private class ActionHandler implements EventHandler<ActionEvent>
    {
        /**
         * Processes an action event and delegates it to the appropriate application operation.
         *
         * @param event
         *        the action event generated by a user-interface control
         */
        @Override
