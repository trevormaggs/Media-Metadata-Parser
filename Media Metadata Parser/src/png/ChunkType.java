...
public enum ChunkType
{
    ...
    cHRM("cHRM", "Primary chromaticities and white point", Category.COLORSPACE),
    cICP("cICP", "Coding-independent code points", Category.COLORSPACE),
    gAMA("gAMA", "Image Gamma", Category.COLORSPACE),
    iCCP("iCCP", "Embedded ICC profile", Category.COLORSPACE),
    mDCV("mDCV", "Mastering Display Color Volume", Category.COLORSPACE),
    cLLI("cLLI", "Content Light Level Information", Category.COLORSPACE),
    sBIT("sBIT", "Significant bits", Category.COLORSPACE),
    sRGB("sRGB", "Standard RGB color space", Category.COLORSPACE),
    ...
    {
        HEADER("Image Header (IHDR)"),
        PALETTE("Palette Table (PLTE)"),
        DATA("Image Data (IDAT)"),
        END("Image Trailer (IEND)"),
        COLORSPACE("Colour Space Information"),
        MISC("Miscellaneous Metadata"),
        TRANSP("Transparency Information"),
        TEXTUAL("Textual Metadata"),
        ANIMATION("Animation Control Metadata"),
        TIME("Image Modification Time (tIME)"),
        UNDEFINED("Undefined Chunks");
