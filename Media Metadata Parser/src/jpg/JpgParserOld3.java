 ...
 * @since 22 May 2026
 */
public class JpgParserOld3 extends AbstractImageParser<TifMetadata>
{
    private static final LogFactory LOGGER = LogFactory.getLogger(JpgParserOld3.class);
     ...
     */
    public JpgParserOld3(String file) throws IOException
    {
        this(Paths.get(file));
    }
     ...
     *         if the file cannot be opened or read
     */
    public JpgParserOld3(Path fpath) throws IOException
    {
        super(fpath);
            ...
            if (segment.hasLengthField())
            {
                ...
                if (segment == JpgSegmentConstants.APP1_SEGMENT || segment == JpgSegmentConstants.APP2_SEGMENT)
                {
                    ...
                    if (segment == JpgSegmentConstants.APP1_SEGMENT)
                    {
                        if (exifSegment == null)
                        {
                            byte[] strippedPayload = JpgParserOld3.stripExifPreamble(payload);
