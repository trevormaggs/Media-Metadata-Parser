...
public class TagTranslator2
{
    ...
    private static String translateDngVersion(Object val)
    {
        if (val instanceof byte[])
        {
            ...
            if (b.length >= 4)
            {
                return String.format(Locale.ROOT, "%d.%d.%d.%d", b[0], b[1], b[2], b[3]);
            }
        }
    ...
    /**
     * Translates ProfileEmbedPolicy (0xC6FD). Defines how the profile can be used
     * when copying or modifying the file.
     */
    ...
    /**
     * Translates PreviewColorSpace (0xC71A). Indicates the color space used for rendering the
     * preview frame.
     */
    ...
    /**
     * Translates DepthUnits (0xC7EC). Specifies structural distance units
     * for depth map layers.
     */
    ...
    /**
     * Translates DepthMeasureType (0xC7ED). Defines whether the depth metrics represent absolute
     * optical depth or inverse parity.
     */
