...
public enum TagIFD_Private implements Taggable
{
    ...
    IFD_XPTITLE(0x9C9B, "XP Title", TagHint.HINT_UCS2),
    IFD_XPCOMMENT(0x9C9C, "XP Comment", TagHint.HINT_UCS2),
    IFD_XPAUTHOR(0x9C9D, "XP Author", TagHint.HINT_UCS2),
    IFD_XPKEYWORDS(0x9C9E, "XP Keywords", TagHint.HINT_UCS2),
    IFD_XPSUBJECT(0x9C9F, "XP Subject", TagHint.HINT_UCS2),
