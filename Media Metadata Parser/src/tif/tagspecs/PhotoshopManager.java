...
public final class PhotoshopManager
{
     ...
     */
    public static void decodePhotoshopProperties(Object val, PropertyBiConsumer display)
    {
        byte[] bytes;
     ...
     */
    private static void translateColorHalftoningInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateResolutionInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateAlphaChannelNames(ByteArrayReader reader, int dataSize, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintFlags(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateColorTransferFunctions(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateQuickMaskInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateThumbnailInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateGlobalAngle(ByteArrayReader reader, PropertyBiConsumer display)
    {
        if (reader.hasRemaining(Integer.BYTES))
        {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateGlobalAltitude(ByteArrayReader reader, PropertyBiConsumer display)
    {
        if (reader.hasRemaining(Integer.BYTES))
        {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateSlicesInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintStyleFallback(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintPositionFallback(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintScaleFallback(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateVersionInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintScaleInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
        if (reader.hasRemaining(14))
        {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePixelAspectRatio(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translatePrintFlagsInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateGridGuidesInfo(ByteArrayReader reader, PropertyBiConsumer display)
    {
        if (reader.hasRemaining(16))
        {
            final double Fixed_Point_Multiplier = 1.0 / 65536.0;
     ...
     *        the target streaming handler receiving property pairs
     */
    private static void translateURL(ByteArrayReader reader, short resID, PropertyBiConsumer display)
    {
        int index = 1;
        int totalStrings = 1;
