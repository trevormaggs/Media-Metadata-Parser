 ...
 */
public class RationalNumberOld extends Number
{
     ...
     */
    private RationalNumberOld(long num, long div, DataType type, boolean normalise)
    {
        if (div == 0 && num != 0)
        {
     ...
     */
    public RationalNumberOld(int num, int div, DataType type)
    {
     ...
     */
    public RationalNumberOld(int num, int div)
    {
     ...
     */
    public static RationalNumberOld simplify(long numerator, long divisor, DataType type)
    {
        return new RationalNumberOld(numerator, divisor, type, true);
    }
     ...
     */
    public RationalNumberOld negate()
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        if (!(obj instanceof RationalNumberOld))
        {
            return false;
        }

        RationalNumberOld other = (RationalNumberOld) obj;
