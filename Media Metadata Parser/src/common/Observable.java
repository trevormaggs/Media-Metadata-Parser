...
/**
 * An {@code Observable} is an entity that wraps content and allows to observe the content for
 * invalidations.
 * 
 * An implementation of {@code Observable} may support lazy evaluation, which means that the content
 * is not immediately recomputed after changes, but lazily the next time it is requested. All
 ...
 * invalid when the first invalidation event occurs. They do not generate anymore invalidation
...
public interface Observable
{
     ...
     * removeListener} after use or to use an instance of {@link WeakInvalidationListener} avoid
     * this situation.
     *
    ...
    /**
     * Removes the given listener from the list of listeners, that are notified whenever the value
     * of the {@code Observable} becomes invalid.
     * 
     * <p>
