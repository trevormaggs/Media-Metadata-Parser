 ...
 * FfF: Introduce a lock mechanism to prohibit changes in the XMPTree during the iteration;
 * FfF: will throw a ConcurrentModificationException.
 *
...
public class XMPIteratorImpl implements XMPIterator
{
			...
			IteratorOptions options) throws XMPException
	{
		...
		else if (baseSchema  &&  baseProperty)
		{
			...
			// FfF: Shall the indices "last()" and selectors be converted to real indices?
			// FfF: Need to wait for customer input.
			// FfF: in case: findNode would have to change the path accordingly
