...
public enum TagIFD_Exif2 implements Taggable
{
    ...
    private TagIFD_Exif2(int id, DirectoryIdentifier dir, String desc, TagHint clue)
    {
        this.numID = id;
        this.directory = dir;
        this.desc = desc;
    ...
    private TagIFD_Exif2(int id, DirectoryIdentifier dir)
    {
